namespace Vega.Test.Entities.DocumentTypes
{
    ...
    public class SecondLevelDT17 : FirstLevelDT
    {
        ...
        [DocumentTypeProperty(UmbracoPropertyType.Textstring, Name = "Lazy Property", Description = "Lazy property description.")]
        public Lazy<string> LazyPropTests { get; set; }
    }
}
