...
namespace Vega.USiteBuilder.DataTypeBuilder
{
	...
	public class DataTypeAttribute : Attribute
    {
        ...
        /// </summary>
        private Guid renderControlGuid = Guid.Empty;
        ...
        public Guid RenderControlGuid
        {
            get
            {
                Guid guid = Guid.Empty;

                if (renderControlGuid != Guid.Empty)
                {
                ...
                else if (!string.IsNullOrEmpty(this.RenderControlName))
                {
                    ...
                    var dataType =
                        factory.GetAll().FirstOrDefault(d => d.DataTypeName == this.RenderControlName);
